/**
 * @file esp32_cam_live_server.ino
 * @author Petr Kucera(petr@khome.cz)
 * @brief simple live server that returns image
 * @version 0.1
 * @date 2024-11-08
 *
...
void setup()
{
   ...
   if (psramFound()) {
      ...
      config.fb_count = 2;
      Serial.println("PS RAM found - fast mode selected");
    #else
